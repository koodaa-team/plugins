...
Downloaded by pub (not CocoaPods).
                       DESC
  s.homepage         = 'https://github.com/koodaa-team/plugins'
  s.license          = { :type => 'BSD', :file => '../LICENSE' }
  s.author           = { 'Flutter Dev Team' => 'flutter-dev@googlegroups.com' }
  s.source           = { :http => 'https://github.com/koodaa-team/plugins/tree/enable_pip/packages/video_player/video_player_avfoundation' }
